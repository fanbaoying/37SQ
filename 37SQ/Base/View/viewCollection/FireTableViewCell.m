...
- (void)layoutSubviews{
    ...
    self.nameLab.frame = CGRectMake((SCREEN_WIDTH-20)/3+20, 65, 35, 20);
    
    self.nameLab1.frame = CGRectMake((SCREEN_WIDTH-20)/3+55, 65, 60, 20);
    
    self.playLab.frame = CGRectMake(SCREEN_WIDTH-80, 65, 30, 20);
    
    self.playLab1.frame = CGRectMake(SCREEN_WIDTH-50, 65, 40, 20);
