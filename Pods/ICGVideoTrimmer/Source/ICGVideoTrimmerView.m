...
@property(assign,nonatomic)int intString;
...
- (CGFloat)maxLength
{
    CGFloat totalSecond = _asset.duration.value / _asset.duration.timescale;//转化成秒
    _a = (int) totalSecond;
//    NSLog(@"%d",_a);
    return _maxLength ?: _a;
}

- (CGFloat)minLength
{
    
    return _minLength ?:_a/5;
}
